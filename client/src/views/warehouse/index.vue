  ...
  <div class="orders-page">
    ...
    <div class="task-description">
      ...
      <div class="task-content">
        为保障平台秩序、维护商家权益及用户资金安全，请在参与任务前认真阅读以下规定：一、提现规则为防范洗钱等非法
        行为，白银会员需完成30单、黄金会员完成70单任务后方可申请提现。提现审核通过后资金T+0到账，预计2小时内，具
        体到账时间以银行为准。二、任务机制任务采用“垫付立返”模式，先付款后返佣。每日最多匹配0~3次高佣加急单，
        由系统随机派发，不可取消。每完成一单方可进行下一单，任务积极者有机会参与现金奖励抽取。三、信用分与异常高
        佣单接单后请及时参与，延误可能导致卡单并降低信用分，影响提现与任务匹配资格。四、账户规范每人最多注册两个
        账户，违规将冻结。多账户操作可能导致商家损失并影响平台运营。如有疑问，请联系平台客服。上海寻梦信息技术有
        限公司
      </div>
    </div>
